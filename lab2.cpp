...
int main() {
   ...
   while ( round != -1 ) {
    ...
    cout << "Invaild input!" <<endl << "Enter a position number between 1 to 4 to slide:";
      cin >> choice; 
    }
      ...
      switch (choice){
         ...
         case 3:
            if (pos3 != '*') {
               if (pos4 == '*') { temp = pos4; pos4 = pos3; pos3 = temp; }
               else if (pos1 == '*') { temp = pos1; pos1 = pos3; pos3 = temp; }
            }
